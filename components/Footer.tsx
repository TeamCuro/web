  ...
  return (
    <footer className="bg-secondary-900" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <ul role="list" className="mt-6 space-y-4">
                {navigation.product.map((item) => (
                  <li key={item.name}>
                    <a
                      href={item.href}
                      className="text-sm leading-6 text-secondary-400 hover:text-white transition-colors"
                    >
                      {item.name}
                    </a>
                  </li>
        ...
        {/* Bottom Section */}
        <div className="mt-16 border-t border-secondary-800 pt-8 sm:mt-20 lg:mt-24">
